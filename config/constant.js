...
module.exports = {
  ...
  orderingStartDate: '0 30 20 * * 1-5', // 工作日订餐开始时间
  orderingCenterDate: '0 50 20 * * 1-5', // 订餐中途提醒时间
  orderingTipDate: '0 0 21 * * 1-5', // 订餐即将结束提醒时间
  orderingEndDate: '0 05 21 * * 1-5', // 工作日订餐结束时间
  ...
  city: 'shenzhen', // 所在城市
  roomName: '微信每日说', // 群组名称
  orderingRoomName: '税企华侨城办公区', // 订餐群名称
};
